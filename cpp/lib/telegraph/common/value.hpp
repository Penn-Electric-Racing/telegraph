...
namespace telegraph {
    ...
    public:
        ...
        inline value(bool b) : type_(type::Bool), value_() { value_.b = b; }
        inline value(uint8_t v) : type_(type::Uint8), value_() { value_.uint8 = v; }
        inline value(uint16_t v) : type_(type::Uint16), value_() { value_.uint16 = v; }
        inline value(uint32_t v) : type_(type::Uint32), value_() { value_.uint32 = v; }
        inline value(uint64_t v) : type_(type::Uint64), value_() { value_.uint64 = v; }

        inline value(int8_t v) : type_(type::Int8), value_() { value_.int8 = v; }
        inline value(int16_t v) : type_(type::Int16), value_() { value_.int16 = v; }
        inline value(int32_t v) : type_(type::Int32), value_() { value_.int32 = v; }
        inline value(int64_t v) : type_(type::Int64), value_() { value_.int64 = v; }

        inline value(float v) : type_(type::Float), value_() { value_.f = v; }
        inline value(double v) : type_(type::Double), value_() { value_.d = v; }

        inline value(type::type_class t, uint8_t v) : type_(t), value_() { value_.uint8 = v; }
